<template>
  <div>
    <div
      class="is-desktop"
      :class="`flex items-start container-date ${
        dateMeeting.isActive ? 'active' : ''
      }`"
    >
      ...
      <div class="div-desc pl-4 pt-1 w-full">
        <div class="title items-start -mt-2">
          <h4 class="text-ellipsis overflow-hidden text-name">
            {{ textName }}
          </h4>
        </div>
        <div class="div-time-location -mt-2" v-html="textDesc"></div>
      </div>
      <div
        class="text-base day-ago pt-1 text-right text-a-gray-787878 w-[120px]"
      >
        {{ textDay }}
      </div>
    </div>
    <div class="is-mobile">
      <div class="container-date-mobile">
        <div
          class="div-date"
          :class="[`${dateMeeting.isActive ? 'active' : ''}`]"
        >
          <div class="text-date">{{ date }}</div>
          <div class="mmyyyy text-mmyyyy">
      ...
      <div class="div-desc-mobile">
        ...
        <div class="div-time-location-mobile" v-html="textDesc"></div>
      </div>
    </div>
  </div>
</template>
